...
namespace HouseF
{
    public class HouseType2 : IHouse
    {

        private int _noOfRooms = 8;
        private int _noOfWindows = 12;
        private string _streetAdress = "Fyrgatan 2";
        private bool _hasSwimmingPool = true;
        private int _parkingSpotsInGarage = 2;
